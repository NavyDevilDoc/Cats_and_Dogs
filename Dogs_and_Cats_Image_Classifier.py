...
val_cats = sum(validation_generator.labels == 0)  # Assuming 0 is the label for 'cat'
val_dogs = sum(validation_generator.labels == 1)  # Assuming 1 is the label for 'dog'
print(f"Validation set has {val_cats} cat images and {val_dogs} dog images.")
# Counting test instances
test_cats = sum(test_generator.labels == 0)  # Assuming 0 is the label for 'cat'
test_dogs = sum(test_generator.labels == 1)  # Assuming 1 is the label for 'dog'
